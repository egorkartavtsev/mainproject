	...
	public function index() {
		...
		/* octeam */
			...
			$data['token_excel'] = $this->session->data['token'];
                        ...
                        $data['edit_prod'] = array(
                            'edit_model' => $this->language->get('edit_model'),
                            'excel' => $this->language->get('excel'),
                            'tempdesc' => $this->language->get('tempdesc'),
                            'add_prod' => $this->language->get('add_prod'),
                            'add_photo' => $this->language->get('add_photo'),
                            'adm_prod' => $this->language->get('adm_prod'),
                            'write-off' => $this->language->get('write-off'),
                            'list' => $this->language->get('list'),
                            'complect' => $this->language->get('complect'),
                            'refund' => $this->language->get('refund')
                        );
                        $data['tiresdisc'] = array(
                            'main' => $this->language->get('tiresdisc'),
