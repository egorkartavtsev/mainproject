...
class ControllerCatalogProduct extends Controller {
					...
					break;
                        ...
                        if($result['product_id']!=NULL){
                            $data['products'][] = array(
                                    ...
                                    'edit'       => $this->url->link('product/product_edit', 'token=' . $this->session->data['token'] . '&product_id=' . $result['product_id'] . $url, true)
                            );
                        }
		}
    ...
    if ($this->config->get('config_editor_default')) {
		...
		if (isset($this->request->post['location'])) {
			...
			$data['location'] = str_replace(',','/',$product_info['location']);
		} else {
			$data['location'] = '';
		}
