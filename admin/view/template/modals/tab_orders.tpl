<div role="tabpanel" class="tab-pane" id="orders">
    ...
    <?php foreach($orders as $order){ ?>
        <div class="alert alert-<?php echo (int)$order['viewed']?'success':'danger';?>">
            ...
            <div class="col-sm-3 text-center"><b><?php echo $order['telephone'].'<br>'.$order['email'];?></b></div>
            <div class="col-sm-3 text-right"><b><?php echo date("d.m.Y H:i:s", strtotime($order['date_added']));?></b></div>
