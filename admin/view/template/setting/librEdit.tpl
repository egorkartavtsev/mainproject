        ...
        <div class="<?php echo $library['divClass']?>">
            ...
            <div class="well well-sm" library-id="<?php echo $library_id;?>">
                <table class="table table-bordered table-striped table-hover" id="<?php echo $item['name']?>" level="<?php echo $key+1;?>" item-id="<?php echo $item['item_id']?>">
                    ...
                    <tr id="fill<?php echo $row['id'];?>" fill_id='<?php echo $row["id"];?>' item_level = '<?php echo $key + 1;?>'><td td_type="fillName"><?php echo $row['name']?></td><td><button class="btn btn-info" btn_type="changeFill"><i class="fa fa-pencil" ></i></button><button class="btn btn-danger" btn_type="deleteFill"><i class="fa fa-trash-o"></i></button></td></tr>
                    <?php }?>
