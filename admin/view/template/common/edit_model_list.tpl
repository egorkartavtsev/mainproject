...
<div id="content">
    ...
    <div class="container-fluid">
        ...
        <script type="text/javascript">
            function del($id, $par){
              ajax({  
                url:"index.php?route=common/edit_model/deleteModel&token=<?php echo $token_em; ?>",
                statbox:"status",
                method:"POST",
                data:
                {
                ...
                success:function(data){document.getElementById("model_list").innerHTML=data; 
                                       document.getElementById("model_row_list").innerHTML='';}
              })
            }
            function delMR($id, $par){
              ajax({  
                url:"index.php?route=common/edit_model/deleteModel&token=<?php echo $token_em; ?>",
                statbox:"status",
                method:"POST",
            ...
            function addMR(){
              ajax({  
                url:"index.php?route=common/edit_model/addMR&token=<?php echo $token_em; ?>",
                statbox:"status",
                method:"POST",
                data:
                {
                    brand: document.getElementById("mrname").value,
                    parent: document.getElementById("mod_row_par").value,
                    token: "<?php echo $token_em; ?>"
                },
                success:function(data){document.getElementById("model_row_list").innerHTML=data;}
              })                
            ...
            function addM(){
              ajax({  
                url:"index.php?route=common/edit_model/addM&token=<?php echo $token_em; ?>",
                statbox:"status",
                method:"POST",
                data:
                {
                    brand: document.getElementById("mname").value,
                    parent: document.getElementById("mod_par").value,
                    token: "<?php echo $token_em; ?>"
                },
                success:function(data){document.getElementById("model_list").innerHTML=data;}
              })
