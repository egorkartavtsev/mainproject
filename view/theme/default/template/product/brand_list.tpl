      ...
      <?php } ?>-->
        <div class="row">  
            <?php if ($brands) { ?>
                ...
                <div style="min-height: 107px;" class="col-lg-2 col-md-2 col-sm-3 col-xs-3">
                        <div class="center-block col-lg-9">
                            <a href='<?php echo $brand["href"];?>'><img style="margin-left: 20%;" src="<?php echo $brand['img']; ?>" alt="<?php echo $brand['name']; ?>" /></a>
                            <p style="text-align: center;"><a href='<?php echo $brand["href"];?>'><?php echo $brand['name']; ?></a></p>
                        </div>
                    </div>
                <?php } ?>
            <?php } ?>
