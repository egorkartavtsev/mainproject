...
<link href="view/theme/default/stylesheet/stylesheet.css?t=<?php echo(microtime(true)); ?>" rel="stylesheet">
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
            <div class="text-right">
                ...
                <a style="cursor: pointer;" href="tg://resolve?domain=Autorazbor174"><img src="<?php echo $tg;?>" width="40"></a>
