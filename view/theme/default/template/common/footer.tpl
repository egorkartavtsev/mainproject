<footer>
  <div class="container">
    ...
    <p style="text-align: center; font-size: 9px;">Сайт носит исключительно информационный характер и ни при каких условиях не является публичной офертой, определяемой положениями ч. 2 ст. 437 Гражданского кодекса Российской Федерации. Для получения подробной информации о наличии и стоимости запасных частей пожалуйста, обращайтесь к специалистам компании.</p>
  </div>
</footer>
